...
new_style = {'/dom { dpi2point 1 currentlinewidth 0.08 mul add mul mul } bdef',... % Dot length macro based on line width
             ...
             '/DO { [3 dpi2point mul] 0 setdash 0 setlinecap } bdef',... % Dotted lines
             '/DA { [6 dpi2point mul] 0 setdash 0 setlinecap } bdef',... % Dashed lines
             '/DD { [6 dpi2point mul 2 dpi2point mul 2 dpi2point mul 2 dpi2point mul] 0 setdash 0 setlinecap } bdef',... % Dot dash lines
